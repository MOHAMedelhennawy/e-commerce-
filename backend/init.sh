...
sudo $EDIT_PACKAGE_SCR build tsc
sudo $EDIT_PACKAGE_SCR start "node dist/server.js"
sudo $EDIT_PACKAGE_SCR dev "nodemon --watch 'src/**/*.ts' --exec 'ts-node' src/server.ts"
